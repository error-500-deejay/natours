        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Login Succesffull');
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            } else {
              (0, _alerts.showAlert)('error', 'Wrong credentials');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logout Succesffull');
              setTimeout(function () {
...
var loginForm = document.querySelector('.form__login--operation');
